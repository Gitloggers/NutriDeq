    ...
    <div class="main-layout">
        ...
        <main class="main-content">
            <div class="page-container">
                ...
                <div class="dashboard-grid admin-grid">
                    ...
                    <div class="stat-card stat-deleted">
                        ...
                        <div class="stat-info">
                            <h3><?php echo $stats['deleted_users'] ?? 0; ?></h3>
                            <p>Deleted Users</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="management-section">
                    ...
                    <div id="active-users-tab"
                        ...
                        <div class="section-header">
                            ...
                            <button class="btn btn-primary btn-add-fab" id="addUserBtn">
                ...
                <div class="management-section">
                    ...
                    <div class="permissions-grid">
                        <div class="permission-card permission-regular">
                            <div class="permission-header">
                                <div class="permission-icon">
                                    <i class="fas fa-user"></i>
                                </div>
                                <div class="permission-title">Regular User</div>
                            </div>
                            <ul class="permission-list">
                                <li><i class="fas fa-check"></i> Access to Dashboard</li>
                                <li><i class="fas fa-check"></i> Health Tracker</li>
                                <li><i class="fas fa-check"></i> Nutrition Calculator</li>
                                <li><i class="fas fa-check"></i> Food Exchange List</li>
                                <li><i class="fas fa-check"></i> Nutrition Facts</li>
                                <li><i class="fas fa-times"></i> User Management</li>
                                <li><i class="fas fa-times"></i> Staff Management</li>
                            </ul>
                        </div>
                        ...
                        <div class="permission-card permission-admin">
                            <div class="permission-header">
                                <div class="permission-icon">
                                    <i class="fas fa-user-cog"></i>
                                </div>
                                <div class="permission-title">Administrator</div>
                            </div>
                            <ul class="permission-list">
                                <li><i class="fas fa-check"></i> All Staff Features</li>
                                <li><i class="fas fa-check"></i> Full User Management</li>
                                <li><i class="fas fa-check"></i> Staff Management</li>
                                <li><i class="fas fa-check"></i> System Settings</li>
                                <li><i class="fas fa-check"></i> Complete System Access</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="POST" action="process_admin_add_user.php" id="addUserForm">
                        ...
                        <div class="form-group">
                            ...
                            <select id="role" name="role" class="form-control" required>
                                <option value="regular" <?php echo (isset($_SESSION['add_user_data']['role']) && $_SESSION['add_user_data']['role'] === 'regular') ? 'selected' : '' ?>>Regular User
                                </option>
                                <option value="staff" <?php echo (isset($_SESSION['add_user_data']['role']) && $_SESSION['add_user_data']['role'] === 'staff') ? 'selected' : '' ?>>Staff Member
                                </option>
                                <option value="admin" <?php echo (isset($_SESSION['add_user_data']['role']) && $_SESSION['add_user_data']['role'] === 'admin') ? 'selected' : '' ?>>Administrator
                                </option>
                            </select>
                        </div>
            ...
            <script>
                    ...
                    if (editButtons && editModal && editForm) {
                        editButtons.forEach(btn => {
                            btn.addEventListener('click', function (e) {
                                ...
                                document.getElementById('edit_role').value = role || 'regular';
                ...
                // Tab switching function - now using standard navigation
                function switchTab(tabName) {
                    // Use standard navigation with page reload
