    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'add_client':
                ...
                $waist_circumference = isset($_POST['waist_circumference']) && $_POST['waist_circumference'] !== '' ? $_POST['waist_circumference'] : null;
                $hip_circumference = isset($_POST['hip_circumference']) && $_POST['hip_circumference'] !== '' ? $_POST['hip_circumference'] : null;
